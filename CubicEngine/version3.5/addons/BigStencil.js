// ==UserScript==
// @name          Drawaria.Modded - BigStencil
// @namespace     https://drawaria.online/profile/?uid=63196790-c7da-11ec-8266-c399f90709b7
// @version       1.0.0
// @description   Bypasses the default stencil sizing limit
// @author        ≺ᴄᴜʙᴇ³≻
...
(function (identifier) {
  ...
  class BigStencil extends Addon {
    static dummy = Addon.register('BigBrush', this);
    static dummy = Addon.bind('Engine', this);

    constructor() {
      super(helper.interface.buildTree('i', { class: 'fas fa-crop' }));
      this.active = false;
      this.init();
    }
