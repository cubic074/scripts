// ==UserScript==
// @name         StencilObserver
// @namespace    CheatEngine
// @version      1.0.0
// @description  Disable Stencil size limit
// @author       ≺ᴄᴜʙᴇ³≻
...
(function (scope) {
  ...
  class StencilObserver extends Cheat {
    ...
    constructor(parentClassReference) {
      ...
      this.active = false;
      this.setIcon(helper.createDOM.FA('<i class="fas fa-box-open"></i>'));
