...
var DrawariaExtensionBundle = (() => {
  ...
  G(ae, {
    ...
    ShellModuleLoader: () => g,
    SocketManager: () => d,
    createAvatarImagePatcherModule: () => R,
    getActiveDrawariaDocument: () => ee,
    initializeDrawariaExtension: () => U,
    initializeDrawariaShell: () => te,
    matchDrawariaShellRoute: () => Z,
    matchShellRoute: () => u,
    ...
    S = class {
      ...
      initialize() {
        ...
        ((this.#E = e),
          ...
          this.#C(this.#e, e, new URL(this.#e.location.href), null));
      }
      cleanup() {
        this.#d &&
          ((this.#d = !1),
      ...
      #P() {
        ...
        ((this.#w = typeof a == "function" ? a : null),
          this.#C(n, t, new URL(this.#A ?? e.src), e));
      }
      #N(e) {
